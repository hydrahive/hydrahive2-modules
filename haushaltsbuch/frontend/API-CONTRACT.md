...
- Das Refresh-Token liegt ausschließlich AES-GCM-verschlüsselt im zentralen Credential-Store. Access-Tokens bleiben nur für die Dauer eines Syncs im Arbeitsspeicher. Tokenrequests authentifizieren den nativen Client ausschließlich per Basic-Header; `client_id` wird nicht zusätzlich im Form-Body dupliziert.
