...
| **VoIP** | 0.1.0 | — | authenticated status router, frontend routes, nav, i18n | Installable foundation for project-bound VoIP connections, phone tasks and call archives; no telephony functions are enabled yet. |
