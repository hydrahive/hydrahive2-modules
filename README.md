...
| **VoIP** | 0.4.2 | — | authenticated registration + incoming-call probe routes, typed gateway contract + fake, frontend routes, nav, i18n | Installable foundation with secret-safe FRITZ!Box registration and controlled incoming-call tests in Settings; persistent connections are not enabled yet. |
