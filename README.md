...
| **Musicplayer** | 1.1.0 | — | router, migration, `buddyMediaWidgets` | Project-scoped, role-aware audio library in Buddy's media slot; stores tracks safely under `media/audio` and supports upload, import, streaming, and download. |
