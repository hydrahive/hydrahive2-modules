...
| **VoIP** | 0.3.0 | — | authenticated status + registration-probe routes, typed gateway contract + fake, frontend routes, nav, i18n | Installable foundation with a secret-safe FRITZ!Box registration test in Settings; calls and persistent connections are not enabled yet. |
