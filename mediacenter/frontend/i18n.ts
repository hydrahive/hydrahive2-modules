export const i18n = {
  de: {
    mediacenter: {
      ...
      views: { label: "Mediacenter-Bereiche", search: "Suche", queue: "Warteschlange", history: "Verlauf", settings: "Einstellungen" },
      settings: {
        title: "Dienste und Verbindungen",
        subtitle: "Alle Adressen und Schlüssel kommen aus dem Credential-Store — hier siehst du, was daraus folgt.",
        notConfigured: "nicht eingerichtet",
        configuredUntested: "eingerichtet, noch nicht geprüft",
        indexerLimit: "max. {{limit}} Treffer je Suche",
        credentialHint: "Adresse und Schlüssel jedes Dienstes stehen in einem Credential. Die Adresse gehört ins Feld URL/Muster — eine zweite Konfiguration gibt es nicht.",
        openCredentials: "Zugangsdaten verwalten",
        services: { indexer: "Indexer (Treasure Maps)", sab: "SABnzbd" },
        errors: {
          not_configured: "kein Credential hinterlegt",
          unauthorized: "Schlüssel abgelehnt",
          unreachable: "nicht erreichbar",
          invalid_response: "unerwartete Antwort",
          response_too_large: "Antwort zu groß",
        },
      },
      ...
      search: {
        ...
        voice: "Per Sprache suchen", understood: "Verstanden:", undoParse: "Rückgängig",
        chips: { year: "Jahr", season: "Staffel", episode: "Folge", language: "Sprache", resolution: "Auflösung", audio_format: "Format", media_type: "Medientyp" },
      },
      results: {
        ...
        versions_one: "{{count}} Fassung", versions_other: "{{count}} Fassungen",
  ...
  en: {
    mediacenter: {
      ...
      views: { label: "Media Center sections", search: "Search", queue: "Queue", history: "History", settings: "Settings" },
      settings: {
        title: "Services and connections",
        subtitle: "Every address and key comes from the credential store — this page only shows the result.",
        notConfigured: "not configured",
        configuredUntested: "configured, not tested yet",
        indexerLimit: "max. {{limit}} results per search",
        credentialHint: "Each service keeps its address and key in one credential. The address belongs in the URL/pattern field — there is no second place to configure it.",
        openCredentials: "Manage credentials",
        services: { indexer: "Indexer (Treasure Maps)", sab: "SABnzbd" },
        errors: {
      ...
      search: {
        ...
        voice: "Search by voice", understood: "Understood:", undoParse: "Undo",
        chips: { year: "Year", season: "Season", episode: "Episode", language: "Language", resolution: "Resolution", audio_format: "Format", media_type: "Media type" },
      },
      results: {
