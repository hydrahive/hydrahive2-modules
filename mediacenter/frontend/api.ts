...
const DE_ERRORS: Record<string, string> = {
  ...
  result_unavailable: "Der Treffer ist abgelaufen (nach 15 Minuten). Bitte neu suchen und erneut übergeben.",
...
const EN_ERRORS: Record<string, string> = {
  ...
  result_unavailable: "The result expired (after 15 minutes). Please search again and retry.",
