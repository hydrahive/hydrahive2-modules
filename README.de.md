...
| **Musicplayer** | 1.0.3 | — | router, migration, `buddyMediaWidgets` | Audio-Player im Cockpit-Design für generierte und hochgeladene Musik mit Playlist und Equalizer im dedizierten Buddy-Media-Slot. |
