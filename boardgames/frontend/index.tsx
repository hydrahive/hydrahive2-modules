...
export const i18n = {
  de: {
    boardgames: {
      ...
      bg_mode_llm: "Gegen ein KI-Modell",
      bg_pick_model: "KI-Modell wählen",
      bg_loading: "Lade Modelle…",
      bg_models_error: "Modelle konnten nicht geladen werden.",
      bg_start: "Partie starten",
      bg_back: "Zurück",
      bg_llm_fallback: "Notzug (Minimax)",
      bg_mode: "Modus",
  ...
  en: {
    boardgames: {
      ...
      bg_mode_llm: "Vs an AI model",
      bg_pick_model: "Choose AI model",
      bg_loading: "Loading models…",
      bg_models_error: "Could not load models.",
      bg_start: "Start game",
      bg_back: "Back",
      bg_llm_fallback: "fallback move (Minimax)",
      bg_mode: "Mode",
